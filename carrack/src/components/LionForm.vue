<template>
  <div class="birdForm">
    <h1>Epheria Carrack : Valor</h1>
    <h5>เรือคาร์แร็คเอเฟเรีย : แข็งแกร่ง</h5>
    ...
    data(){
        return{
            allMaterials:[
                ...
                {id:9, name:'ไม้แปรรูปที่เต็มไปด้วยสีครามเข้ม', level:'gold', demand:170, supply:0, coin:1000, image:'https://bdocodex.com/items/new_icon/03_etc/07_productmaterial/00005812.png'},
                ...
                {id:12, name:'แท่งหินเกลือเจิดจรัส', level:'gold', demand:30, supply:0, coin:1600, image:'https://bdocodex.com/items/new_icon/03_etc/07_productmaterial/00005815.png'},
