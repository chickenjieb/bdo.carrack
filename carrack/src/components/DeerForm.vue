<template>
  <div class="deerForm">
    <h1>Epheria Carrack : Balance</h1>
    <h5>เรือคาร์แร็คเอเฟเรีย : สมดุล</h5>
    <div class="container py-3">
        <div id="fill">
            <table id="deerTable" class="table table-dark">
                <thead>
                    <tr class="row mx-0">
    ...
    data(){
        return{
            allMaterials:[
                ...
                {id:14, name:'น้ำตาแห่งทะเลลึก', level:'orange', demand:50, supply:0, coin:3900, image:'https://bdocodex.com/items/new_icon/03_etc/07_productmaterial/00005821.png'},
