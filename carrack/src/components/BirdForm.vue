<template>
  <div class="birdForm">
    <h1>Epheria Carrack : Volante</h1>
    <h5>เรือคาร์แร็คเอเฟเรีย : ฉุกเฉิน</h5>
...
export default {
    ...
    data(){
        return{
            allMaterials:[
                {id:1, name:'ลำต้นพืชทะเลลึก', level:'green', demand:250, supply:0, coin:600, image:'https://bdocodex.com/items/new_icon/03_etc/07_productmaterial/00005829.png'},
                {id:2, name:'แร่ใต้มหาสมุทรสีเลือดฝาด', level:'gold', demand:100, supply:0, coin:1500, image:'https://bdocodex.com/items/new_icon/03_etc/07_productmaterial/00005807.png'},
                ...
                {id:5, name:'วัตถุโบราณกลุ่มโจรสลัดค็อกซ์ (ต่อสู้)', level:'gold', demand:250, supply:0, coin:800, image:'https://bdocodex.com/items/new_icon/03_etc/07_productmaterial/00005824.png'},
                ...
                {id:7, name:'ไม้อัดเกล็ดพระจันทร์', level:'blue', demand:600, supply:0, coin:160, image:'https://bdocodex.com/items/new_icon/03_etc/07_productmaterial/00005827.png'},
                ...
                {id:12, name:'แท่งหินเกลือเจิดจรัส', demand:30, level:'gold', supply:0, coin:1600, image:'https://bdocodex.com/items/new_icon/03_etc/07_productmaterial/00005815.png'},

                {id:13, name:'ผ้าลินินที่มีเส้นเลือดของพระจันทร์สลักอยู่', level:'gold', demand:210, supply:0, coin:600, image:'https://bdocodex.com/items/new_icon/03_etc/07_productmaterial/00005809.png'},
                ...
                {id:17, name:'อัญมณีมุกเจิดจรัส', level:'gold', demand:30, supply:0, coin:1600, image:'https://bdocodex.com/items/new_icon/03_etc/07_productmaterial/00005831.png'},
